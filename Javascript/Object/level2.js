...
const e= ['make','year','model'] in car4;
console.log(e)
...
const type=typeof(user6.address)
console.log(type)
...
const ObjToArr=Object.keys(inventory7)
...
const ValueToArr=Object.values(data8)
...
c=Object.values(book9).includes(null)
console.log(c)
...
const ReverseString=person10.fullName.split(" ").reverse().join(" ")
